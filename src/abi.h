...
typedef enum Exe6HitType {
    ...
    EXE6_HIT_TYPE_01 = 0x01,
    EXE6_HIT_TYPE_02 = 0x02,
    EXE6_HIT_TYPE_03 = 0x03,
    EXE6_HIT_TYPE_STANDARD_ATTACK = 0x04,
    EXE6_HIT_TYPE_STANDARD_TARGET = 0x05,
    EXE6_HIT_TYPE_06 = 0x06,
    EXE6_HIT_TYPE_07 = 0x07,
    EXE6_HIT_TYPE_08 = 0x08,
    EXE6_HIT_TYPE_09 = 0x09,
    EXE6_HIT_TYPE_0A = 0x0A,
    EXE6_HIT_TYPE_0B = 0x0B,
    EXE6_HIT_TYPE_0C = 0x0C,
    EXE6_HIT_TYPE_0D = 0x0D,
    EXE6_HIT_TYPE_0E = 0x0E,
    EXE6_HIT_TYPE_0F = 0x0F,
    EXE6_HIT_TYPE_10 = 0x10,
