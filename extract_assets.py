...
ASSETS = (
    ...
    Asset("bn4_blue_moon", "rollarrow-icon-1.bin", 0x74476C, 0x80),
    Asset("bn4_blue_moon", "rollarrow-icon-2.bin", 0x7447EC, 0x80),
    Asset("bn4_blue_moon", "rollarrow-icon-3.bin", 0x74486C, 0x80),
    Asset("bn4_blue_moon", "rollarrow-image.bin", 0x729D2C, 0x540),
    Asset("bn4_blue_moon", "rollarrow-pal-1.bin", 0x73EAEC, 0x20),
    Asset("bn4_blue_moon", "rollarrow-pal-2.bin", 0x73EB0C, 0x20),
    Asset("bn4_blue_moon", "rollarrow-pal-3.bin", 0x73EB2C, 0x20),
